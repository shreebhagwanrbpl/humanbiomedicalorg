...
export async function fetchHomeData() {
  return fetchDocCached("websites/humanbiomedicalorg/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/humanbiomedicalorg/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/humanbiomedicalorg/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/humanbiomedicalorg/districts/${district}`);
}
